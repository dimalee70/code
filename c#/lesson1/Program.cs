...
namespace lesson1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // myByte = 20;// инициализация

            // byte myByte2 = 20;//декларация с инициализацией

            // sbyte mySbyte = -12;

            // ulong myLong = 10000000000002392023;


            // double myDouble = 1.2342342432423423;
            // float myFloat = 178.2342342432423423f;

            // decimal myDecimal = 1.2342342432423423M;
            ...
            // int newDinInt = myDynamic;
            // myDynamic = "dsfds";

            // dynamic myDateTime = DateTime.Today.Day;
            // System.Console.WriteLine(myDateTime);
            // System.Console.WriteLine(myDateTime.GetType());
            ...
            // System.Console.WriteLine(myInt32);
            // System.Console.WriteLine(myInt2);


            // System.Console.WriteLine(myBlool);
            // string nullString = null;
            // System.Console.WriteLine(nullString);

            // int? nullInt = null;//nullable
            ...
            // System.Console.WriteLine((t + t2) + name);
            // string text = "hello";
            // string text2 = "my";
            // string text3 = "name";
            // System.Console.WriteLine($"text1 = {text} \ntext2 = {text2}\ntext3 = {text3}");
            // System.Console.WriteLine("text1 = {0} \ntext2 = {1}\ntext3 = {2}",text,text2,text3);
            // System.Console.WriteLine("text1 = "+text + "\ntext2 " + text2);
            ...
            // double myDouble = 1.2322322434321323143443423423423;
            // System.Console.WriteLine(myDouble);
            ...
            // System.Console.WriteLine($"date3 {date3}");
            // string myString = "\"привет\"- сказал учитель."; 
            ...
            // object myObject = 123.3234243423423432432423423D;
            // myObject = "hello";
            // string myString2 = myObject;

            // var myVar = 12;

            // dynamic myDynamic = "12";
            // myDynamic = 12;
            // int number = myDynamic;
            // string myString3 = myDynamic;
...
// byte	1	1   0 to 255  8 bit = 2^8 == 256
// sbyte	1	-128 to 127
// short	2	-32768 to 32767 2^8 * 2^8
// ushort	2	0 to 65535
